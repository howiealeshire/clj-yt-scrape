(ns clj-yt-scrape-port.api-parser.parse-api-responses)
...
(defn sample-search-list-body-search4 [response]
  (m/search                                                 ;using meander
   {:response response}
   {:response
    {:kind  ?outer-kind
     :etag  ?outer-etag
     :items (m/scan
             {:etag    ?etag
              :id      {:kind ?kind :channelId ?channel-id}
   ...
   {:outer-kind ?outer-kind :outer-etag ?outer-etag :kind ?kind :channelId ?channel-id :title ?title :desc ?desc})
  )



(defn sample-channel-list-body-search4 [response]
  (m/search                                                 ;using meander
    {:response response}
    {:response
     {:kind  ?outer-kind
    ...
    {:outer-kind ?outer-kind :outer-etag ?outer-etag :channelId ?id :title ?title :desc ?desc}
    ))

(defn sample-video-list-body-search4 [response]
  (m/search                                                 ;using meander
    {:response response}
    {:response
     {:kind  ?outer-kind
...
(defn sample-video-list-body-search5 [response]
  (m/search                                                 ;using meander
    {:response response}
    {:response
     {:kind  ?outer-kind
    ...
    {:outer-kind ?outer-kind :outer-etag ?outer-etag :kind ?kind :vid-id ?id :etag  ?etag :channel-id ?channel-id :title ?title :desc ?desc
     :tags ?tags :category-id ?category-id :channel-title ?channel-title :language ?language :view-count ?view-count :like-count ?like-count
     :dislike-count ?dislike-count :comment-count ?comment-count}
    ))



(defn sample-video-list-body-search6 [response]
  (m/search                                                 ;using meander
    {:response response}
    {:response
     {:kind  ?outer-kind
    ...
    {:outer-kind ?outer-kind :outer-etag ?outer-etag :kind ?kind :vid-id ?id :etag  ?etag :channel-id ?channel-id :title ?title :desc ?desc
     :tags ?tags :category-id ?category-id :channel-title ?channel-title :language ?language}
    ))
